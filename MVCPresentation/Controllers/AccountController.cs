                ...
                try
                {
                    if (usrMgr.FindUser(model.Email))
                    {
                        ...
                        var user = new ApplicationUser
                        {
                            ...
                            PixelUserName = oldUser.Username,
                            DisplayName = oldUser.DisplayName,
                            ShortBio = oldUser.ShortBio,
                        ...
                        if (result.Succeeded)
                        {
                            var roles = usrMgr.RetrieveAllRoles();
                            foreach (var role in roles)
                            {
                                if (role.Equals(usrMgr.GetUserRole(oldUser.UserID)))
                                {
                            ...
                            return RedirectToAction("Gallery", "Art");
                        }
                    ...
                    else
                    {
                        var user = new ApplicationUser
                        {
                            PixelUserName = model.PixelUserName,
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    else 
                    {
                        ...
                        {
                            var employeeID = usrMgr.RetreieveUserIdFromEmail(model.Email);
                            var user = new ApplicationUser
                            {
                                UserId = employeeID,
                                PixelUserName = model.PixelUserName,
